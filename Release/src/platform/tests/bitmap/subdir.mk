...
C_SRCS += \
../src/platform/tests/bitmap/bitmap.c 

OBJS += \
./src/platform/tests/bitmap/bitmap.o 

C_DEPS += \
./src/platform/tests/bitmap/bitmap.d 


# Each subdirectory must supply rules for building sources it contributes
src/platform/tests/bitmap/%.o: ../src/platform/tests/bitmap/%.c
	@echo 'Building file: $<'

...
C_SRCS += \
../src/platform/tests/ringbuf/ringbuf.c 

OBJS += \
./src/platform/tests/ringbuf/ringbuf.o 

C_DEPS += \
./src/platform/tests/ringbuf/ringbuf.d 


# Each subdirectory must supply rules for building sources it contributes
src/platform/tests/ringbuf/%.o: ../src/platform/tests/ringbuf/%.c
	@echo 'Building file: $<'

...
\item {\tt /* TODO: ... */} This comment denotes a message about a
  ...
  necessary for correct functionality, but might result in sub-optimal
  performance, or inconvenient functionality.  Work to be done in the
  future, but work that is not essential.
 ...
 */
  ...
  welcomed, and in emacs {\tt artist-mode} can be quite useful in
...
\item {\em Pre-conditions, post-conditions, and invariants}.  Often
  ...
  case, it is useful to include a comment before the function (a
  function to add a child to a tree in this case):
    \begin{minipage}{3in}
      \footnotesize
      \lstset{language=C}
      \begin{lstlisting}

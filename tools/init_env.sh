...
ubuntu64()
{
	...
	local dependencies="build-essential git cargo xorriso mtools qemu-system-i386 gcc-multilib grub-pc-bin python3-pip graphviz gdb"
...
fedora64()
{
	...
	local dependencies="g++ git cargo python2.7 xorriso mtools qemu glibc-devel.i686 libstdc++-devel.i686 python3-pip graphviz"

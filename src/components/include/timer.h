...
static inline void timer_end(struct timer *t)
{
...
static inline void timer_report(struct timer_record *rs, int type, unsigned long *avg, 
...
struct timer { int nothing; };
struct timer_record { int nothing; };
#define STATIC_TIMER_RECORDS(name, N) struct timer_record * name
#define TIMER_INIT(name, rs, idx) struct timer name
static inline void timer_start(struct timer *t) { return; }
static inline void timer_end(struct timer *t) { return; }
static inline void timer_report(struct timer_record *rs, int type, unsigned long *a,

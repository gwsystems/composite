...
__cos_syscall(int, long, long, long, long, long, long);

static inline long __syscall0(long n)
{
	return __cos_syscall(n, 0, 0, 0, 0, 0, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, 0, 0, 0, 0, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, a2, 0, 0, 0, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, a2, a3, 0, 0, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, a2, a3, a4, 0, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, a2, a3, a4, a5, 0);
	/*unsigned long __ret;
...
{
	return __cos_syscall(n, a1, a2, a3, a4, a5, a6);
	/*unsigned long __ret;

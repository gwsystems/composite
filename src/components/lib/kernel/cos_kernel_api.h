...
int     cos_hw_attach(hwcap_t hwc, hwid_t hwid, captblcap_t rcv_ctcap, arcvcap_t rcvcap);
int     cos_hw_periodic_attach(hwcap_t hwc, hwid_t hwid, captblcap_t rcv_ctcap, arcvcap_t rcvcap, unsigned int period);

...
// 	let mut comp_store = voter_lib::CompStore::new();
// 	let reader_id = voter_lib::ModComp::new(num_reps,&mut comp_store,sl,thd_block);
// 	let writer_id = voter_lib::ModComp::new(num_reps,&mut comp_store,sl,thd_block);
// 	let channel = Channel::new(reader_id,writer_id,&mut comp_store,sl);
// 	println!("Channle Created - {:?}", channel.lock().deref());
// 	sl.block_for(Duration::new(2,0));
// 	println!("channel wake");
// 	channel.lock().deref_mut().wake_all(&mut comp_store);
// 	println!("Channel Calling Vote: Expected: Inconclusive : {:?},", channel.lock().deref_mut().call_vote(& mut comp_store));
// }
...
// 	let mut comp_store = voter_lib::CompStore::new();
// 	let reader = voter_lib::ModComp::new(num_reps,&mut comp_store,sl ,thd_rcv);
// 	let _channel = Channel::new(
// 		voter_lib::ModComp::new(num_reps,&mut comp_store,sl ,thd_send),
// 		reader,
// 		&mut comp_store,
// 		sl
// 	);
// 	wait_for_done(&(comp_store.components[reader]),sl);
// }
...
// 	let mut comp_store = voter_lib::CompStore::new();
// 	let writer = voter_lib::ModComp::new(3,&mut comp_store,sl ,thd_send_same);
// 	let channel = Channel::new(
// 		writer,
// 		voter_lib::ModComp::new(1,&mut comp_store,sl ,no_op),
// 		&mut comp_store,
// 		sl
// 	);
// 	wait_for_done(&(comp_store.components[writer]),sl);
...
// 	let mut comp_store = voter_lib::CompStore::new();
// 	let writer = voter_lib::ModComp::new(3,&mut comp_store,sl ,thd_send_diff);
// 	let channel = Channel::new(
// 		writer,
// 		voter_lib::ModComp::new(1,&mut comp_store,sl ,no_op),
// 		&mut comp_store,

...
test_thds_create_switch(void)
{
        ...
        ts = cos_thd_alloc(&booter_info, booter_info.comp_cap, bounceback, NULL, 0, 0, 0, 0);
...
test_async_endpoints_perf(void)
{
        ...
        tcc = cos_thd_alloc(&booter_info, booter_info.comp_cap, async_thd_fn_perf, (void *)tcp, 0, 0, 0, 0);

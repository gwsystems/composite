...
/** 
 * this is a booter that makes sure to checkpoint components
 */
#include <stdlib.h>
#include <limits.h>
...
static struct crt_comp *
chkpt_comp_get(struct crt_comp *comp)
{
	return comp;
}
...
void 
chkpt_comp_init(struct crt_comp *comp, struct crt_chkpt *chkpt)
{

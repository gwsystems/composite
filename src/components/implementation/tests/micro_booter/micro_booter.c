...
cos_init(void)
{
	...
	if (first_init) {
		...
		cos_meminfo_init(&booter_info.mi, BOOT_MEM_KM_BASE, 0x20000000 /* COS_MEM_KERN_PA_SZ */,
	...
	/* NOTE: This is just to make sense of the output on HW! To understand that microbooter runs to completion on
	 * all cores! */

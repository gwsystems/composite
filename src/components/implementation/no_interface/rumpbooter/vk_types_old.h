...
enum {
	...
	VM0_CAPTBL_LAST_CAP                 = round_up_to_pow2(VM0_CAPTBL_SELF_IOSINV_MAP + CAP64B_IDSZ, CAPMAX_ENTRY_SZ),
#elif defined(__SIMPLE_XEN_LIKE_TCAPS__)
	/* RG, I need a place where the vkernel can copy in to vm0 a sinv to vmx */
	...
	VM0_CAPTBL_LAST_CAP                 = round_up_to_pow2(VM0_CAPTBL_SELF_IOSINV_MAP + CAP64B_IDSZ*(COS_VIRT_MACH_COUNT-1), CAPMAX_ENTRY_SZ),
#endif

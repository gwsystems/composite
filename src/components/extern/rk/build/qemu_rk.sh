...
qemu-system-i386 -enable-kvm -rtc base=localtime,clock=host,driftfix=none -smp sockets=1,cores=2,threads=1 -cpu host -net nic,model=virtio -net tap,script=no,ifname=tap0 -nographic -m 768 -kernel kernel.img -initrd "$(echo $MODULES | tr ' ' ',')"

...
COS_CLIENT_STUB(arcvcap_t, capmgr_rcv_create)
(struct usr_inv_cap *uc, spdid_t child, thdid_t tid, cos_channelkey_t key, microsec_t ipiwin, u32_t ipimax)
{
...
COS_CLIENT_STUB(thdcap_t, capmgr_thd_create_ext)
(struct usr_inv_cap *uc, spdid_t child, thdclosure_index_t idx, thdid_t *tid)
{
	word_t   unused, tid_ret;
	thdcap_t ret;
...
COS_CLIENT_STUB(thdcap_t, capmgr_aep_create_thunk)
(struct usr_inv_cap *uc, struct cos_aep_info *aep, thdclosure_index_t idx, int owntc, cos_channelkey_t key,
...
COS_CLIENT_STUB(thdcap_t, capmgr_aep_create_ext)
(struct usr_inv_cap *uc, spdid_t child, struct cos_aep_info *aep, thdclosure_index_t idx, int owntc,
...
COS_CLIENT_STUB(thdcap_t, capmgr_initaep_create)
(struct usr_inv_cap *uc, spdid_t child, struct cos_aep_info *aep, int owntc, cos_channelkey_t key, microsec_t ipiwin,
 u32_t ipimax, asndcap_t *snd)
{

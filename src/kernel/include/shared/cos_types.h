...
enum {
	...
	BOOT_CAPTBL_USERSPACE_THD      = round_up_to_pow2(BOOT_CAPTBL_SELF_INITHW_BASE + CAP32B_IDSZ, CAPMAX_ENTRY_SZ),
	BOOT_CAPTBL_LAST_CAP           = round_up_to_pow2(BOOT_CAPTBL_USERSPACE_THD + CAP32B_IDSZ, CAPMAX_ENTRY_SZ),

...
static inline int cos_cap_send_ipi(int ignore, void *a) {(void)(ignore); (void)(a); return 0;}
static inline int cap_switch_thd(void *ignore, void *a, void *b, void *c) {(void)(ignore);(void)a;(void)b;(void)c; return 0;}

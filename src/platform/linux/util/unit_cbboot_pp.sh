...
!cpu.o, ;(!cpu1.o=cpu.o), ;!cbboot.o,a6;(!po.o=ppong.o), ;(!pi.o=pingp.o), a9;!cbuf.o,a5;!va.o, a2;!l.o,a1;!mpool.o, a3;!vm.o, a1:\
c0.o-llboot.o;\
fprr.o-print.o|[parent_]mm.o|[faulthndlr_]llboot.o;\
mm.o-[parent_]llboot.o|print.o;\
boot.o-print.o|fprr.o|mm.o|llboot.o;\
cpu.o-print.o|fprr.o|mm.o|llboot.o;\
cpu1.o-print.o|fprr.o|mm.o|llboot.o;\
\
...
cbuf.o-boot.o|fprr.o|print.o|l.o|mm.o|va.o|llboot.o|llboot.o;\

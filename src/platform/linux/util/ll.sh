...
\
(!p0.o=pt.o),a7'p10';(!p1.o=pt.o),a8'p20';\
(!p3.o=pt.o),a8'p20 n1';(!p4.o=pt.o),a8'p20 n1';(!p5.o=pt.o),a8'p20 n1';\
(!p6.o=pt.o),a9'p33 n1';(!p7.o=pt.o),a11'p333 n1';(!p11.o=pt.o),a9'p33 n1';(!p12.o=pt.o),a9'p33 n1';(!p13.o=pt.o),a9'p33 n1';(!p14.o=pt.o),a10'p40 n1';(!p15.o=pt.o),a10'p40 n1';(!p16.o=pt.o),a10'p40 n1';(!p17.o=pt.o),a10'p40 n1';(!p18.o=pt.o),a10'p40 n1';(!p19.o=pt.o),a10'p40 n1';\
\
...
p11.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p12.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p13.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p14.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p15.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p16.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p17.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p18.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
p19.o-te.o|fprr.o|schedconf.o|print.o|sh18.o|sm.o;\
\

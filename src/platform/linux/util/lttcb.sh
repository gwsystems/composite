...
\
!l.o,a8;!stat.o,a25;!te.o,a3;!e.o,a3;!smn.o,a2;!va.o,a1;!buf.o,a2;!cbp.o,a4;\
\
(!p0.o=exe_cb_pt.o),a9'p5 e500 s0 d120 m1';\
(!p1.o=exe_cb_pt.o),a11'p7 e700 s0 d120 m1';\
(!p2.o=exe_cb_pt.o),a8'p4 e3600 s0 d120 m1';\
(!p3.o=exe_cb_pt.o),a10'p6 e2400 s0 d120 m1';\
(!p4.o=exe_cb_pt.o),a10'p6 e600 s0 d120 m1';\
(!p5.o=exe_cb_pt.o),a7'p3 e1500 s0 d120 m1';\
(!p6.o=exe_cb_pt.o),a7'p3 e1800 s0 d120 m1';\
(!p7.o=exe_cb_pt.o),a12'p13 e10400 s0 d120 m1';\
(!p8.o=exe_cb_pt.o),a14'p29 e2900 s0 d120 m1';\
(!p9.o=exe_cb_pt.o),a13'p17 e6800 s0 d120 m1';\
\
...
sh2.o-fprr.o|schedconf.o|print.o|[calll_]sh4.o|[callr_]sh5.o|smn.o|buf.o|va.o|mm.o;\
sh3.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh6.o|smn.o|buf.o|va.o|mm.o;\
sh4.o-fprr.o|schedconf.o|print.o|[calll_]sh6.o|[callr_]sh7.o|smn.o|buf.o|va.o|mm.o;\
sh5.o-fprr.o|schedconf.o|print.o|[calll_]sh7.o|[callr_]exe_cb_sbc.o|smn.o|buf.o|va.o|mm.o;\
sh6.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh8.o|smn.o|buf.o|va.o|mm.o;\
...
\
exe_cb_sbc.o-smn.o|buf.o|va.o|mm.o\
" ./gen_client_stub

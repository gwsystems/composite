...
p8.o-te.o|fprr.o|schedconf.o|print.o|[calll_]sh10.o|[callr_]sh9.o|sm.o;\
\
sh9.o-fprr.o|schedconf.o|print.o|[calll_]sh10.o|[callr_]sh11.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh10.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh12.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh11.o-fprr.o|schedconf.o|print.o|[calll_]sh12.o|[callr_]sh0.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh12.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh1.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
\
sh18.o-fprr.o|schedconf.o|print.o|[calll_]sh15.o|[callr_]sh19.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh19.o-fprr.o|schedconf.o|print.o|[calll_]sh16.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh15.o-fprr.o|schedconf.o|print.o|[calll_]sh0.o|[callr_]sh16.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh16.o-fprr.o|schedconf.o|print.o|[calll_]sh2.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
\
sh0.o-fprr.o|schedconf.o|print.o|[calll_]sh1.o|[callr_]sh2.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh1.o-fprr.o|schedconf.o|print.o|[calll_]sh3.o|[callr_]sh4.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh2.o-fprr.o|schedconf.o|print.o|[calll_]sh4.o|[callr_]sh5.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh3.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh6.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh4.o-fprr.o|schedconf.o|print.o|[calll_]sh6.o|[callr_]sh7.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh5.o-fprr.o|schedconf.o|print.o|[calll_]sh7.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh6.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]sh8.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh7.o-fprr.o|schedconf.o|print.o|[calll_]sh8.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh8.o-fprr.o|schedconf.o|print.o|[calll_]exe_cb_sbc.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
\
exe_cb_sbc.o-sm.o|va.o|mm.o|print.o\
" ./gen_client_stub

...
p4.o-te.o|fprr.o|print.o|sh18.o|sm.o|buf.o|va.o|mm.o;\
p5.o-te.o|fprr.o|print.o|sh18.o|sm.o|buf.o|va.o|mm.o;\
p6.o-te.o|fprr.o|print.o|sh18.o|sm.o|buf.o|va.o|mm.o;\
p7.o-te.o|fprr.o|print.o|sh18.o|sm.o|buf.o|va.o|mm.o;\
\
sh9.o-fprr.o||print.o|[calll_]sh10.o|[callr_]sh11.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh10.o-fprr.o||print.o|[calll_]sh12.o|[callr_]sh13.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh11.o-fprr.o||print.o|[calll_]sh13.o|[callr_]sh14.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh12.o-fprr.o||print.o|[calll_]sh0.o|[callr_]sh15.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh13.o-fprr.o||print.o|[calll_]sh15.o|[callr_]sh16.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh14.o-fprr.o||print.o|[calll_]sh16.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh15.o-fprr.o||print.o|[calll_]sh2.o|[callr_]sh17.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh16.o-fprr.o||print.o|[calll_]sh17.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh17.o-fprr.o||print.o|[calll_]sh5.o|[callr_]exe_cb_sbc.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh18.o-fprr.o||print.o|[calll_]sh19.o|[callr_]sh20.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh19.o-fprr.o||print.o|[calll_]sh21.o|[callr_]sh22.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh20.o-fprr.o||print.o|[calll_]sh22.o|[callr_]sh23.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh21.o-fprr.o||print.o|[calll_]exe_cb_sbc.o|[callr_]sh24.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh22.o-fprr.o||print.o|[calll_]sh24.o|[callr_]sh25.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh23.o-fprr.o||print.o|[calll_]sh25.o|[callr_]sh0.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh24.o-fprr.o||print.o|[calll_]exe_cb_sbc.o|[callr_]sh26.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh25.o-fprr.o||print.o|[calll_]sh26.o|[callr_]sh1.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
sh26.o-fprr.o||print.o|[calll_]exe_cb_sbc.o|[callr_]sh3.o|sm.o|buf.o|va.o|mm.o|l.o|te.o;\
\

...
\
(!p0.o=exe_cb_pt.o),a10'a10 p3 e6000 s0 d120';\
(!p1.o=exe_cb_pt.o),a11'a11 p4 e8000 s0 d120';\
(!p2.o=exe_cb_pt.o),a12'a12 p5 e20000 s0 d120';\
(!p3.o=exe_cb_pt.o),a13'a13 p50 e100000 s0 d120';\
\

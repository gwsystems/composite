...
stconn.o-print.o|mm.o|fprr.o|va.o|l.o|httpt.o|[from_]tnet.o|cbuf.o|eg.o|pfs.o;\
httpt.o-l.o|print.o|fprr.o|mm.o|cbuf.o|[server_]tasc.o|te.o|va.o|pfs.o;\
stconn2.o-print.o|mm.o|fprr.o|va.o|l.o|rotar.o|[from_]tasc.o|cbuf.o|eg.o|pfs.o;\
tasc.o-fprr.o|print.o|mm.o|cbuf.o|l.o|eg.o|va.o|pfs.o;\

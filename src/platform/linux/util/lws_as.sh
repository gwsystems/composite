...
\
!tasc.o, ;(!stconn2.o=stconn.o), ;!sm.o,a1;!mpool.o, ;!cbuf.o, ;!va.o, ;!vm.o, ;\
...
tnet.o-sm.o|fprr.o|mm.o|print.o|l.o|te.o|eg.o|[parent_]tip.o|port.o|va.o|cbuf.o;\
l.o-fprr.o|mm.o|print.o;\
te.o-sm.o|print.o|fprr.o|mm.o|va.o;\
mm.o-print.o;\
eg.o-sm.o|fprr.o|print.o|mm.o|l.o|va.o;\
stconn.o-sm.o|print.o|mm.o|fprr.o|va.o|l.o|httpt.o|[from_]tnet.o|cbuf.o|eg.o|pfs.o;\
httpt.o-sm.o|l.o|print.o|fprr.o|mm.o|cbuf.o|[server_]tasc.o|te.o|va.o|pfs.o;\
stconn2.o-sm.o|print.o|mm.o|fprr.o|va.o|l.o|rotar.o|[from_]tasc.o|cbuf.o|eg.o|pfs.o;\
tasc.o-sm.o|fprr.o|print.o|mm.o|cbuf.o|l.o|eg.o|va.o|pfs.o;\
rotar.o-sm.o|fprr.o|print.o|mm.o|cbuf.o|l.o|eg.o|va.o|initfs.o|pfs.o;\
initfs.o-fprr.o|print.o;\
tip.o-sm.o|[parent_]tif.o|va.o|fprr.o|print.o|l.o|eg.o|cbuf.o|mm.o;\
port.o-sm.o|l.o;\
tif.o-sm.o|print.o|fprr.o|mm.o|l.o|va.o|eg.o|cbuf.o;\

 ...
 */
/* PRY: modified this enum to accomodate the new page table layout */
//enum {
//	BOOT_CAPTBL_SRET            = 0,
...
enum {
	...
	BOOT_CAPTBL_BOOTVM_PTE      = 20,   //2
	BOOT_CAPTBL_SELF_UNTYPED_PT = 22,   //2
	BOOT_CAPTBL_PHYSM_PTE       = 24,   //2
	BOOT_CAPTBL_KM_PTE          = 26,   //2

	BOOT_CAPTBL_COMP0_CT           = 28, //2
	BOOT_CAPTBL_COMP0_PT           = 30, //2
	BOOT_CAPTBL_COMP0_COMP         = 32, //4

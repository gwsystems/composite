...
p4.o-te.o|fprr.o|print.o|sh9.o|cbuf.o|va.o|mm.o;\
p5.o-te.o|fprr.o|print.o|sh9.o|cbuf.o|va.o|mm.o;\
p6.o-te.o|fprr.o|print.o|sh9.o|cbuf.o|va.o|mm.o;\
p7.o-te.o|fprr.o|print.o|sh9.o|cbuf.o|va.o|mm.o;\
\

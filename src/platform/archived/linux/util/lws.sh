...
ip.o-cbuf.o|if.o;\
port.o-cbuf.o|l.o;\
cm.o-cbuf.o|print.o|mh.o|sc.o|ds.o|ainv.o|[alt_]ainv2.o;\
...
fd3.o-cbuf.o|fn.o|ainv2.o|print.o|mh.o|ds.o|e.o|l.o;\
ainv2.o-cbuf.o|mh.o|print.o|ds.o|l.o|e.o;\
cgi2.o-cbuf.o|fd3.o|ds.o|print.o;\
schedconf.o-print.o;\

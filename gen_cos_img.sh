...
rm /home/user/projects/composite/system_binaries/cos_build-ktest/cos.img
rm /home/user/projects/composite/system_binaries/cos_build-ktest/constructor
rm /home/user/projects/composite/system_binaries/cos_build-ktest/global.tests/tests.kernel_tests.global.tests

set -e
./cos init
./cos build
./cos compose composition_scripts/kernel_test.toml ktest

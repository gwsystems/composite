...
static inline int __cos_vect_init(cos_vect_t *v)
{
...
static inline void cos_vect_init_static(cos_vect_t *v)
{
	__cos_vect_init(v);
}

static inline void cos_vect_init(cos_vect_t *v, struct cos_vect_intern_struct *vs)
{
	v->vect = vs;
	__cos_vect_init(v);
}
...
static int cos_vect_alloc_vect_data(cos_vect_t *v)
{
...
static cos_vect_t *cos_vect_alloc_vect(void)
{
	cos_vect_t *v;
...
static void cos_vect_free_vect(cos_vect_t *v)
{
	assert(v && v->vect);
...
static inline struct cos_vect_intern_struct *__cos_vect_lookup(cos_vect_t *v, long id)
{
	long depth;
	struct cos_vect_intern_struct *is;
...
static inline void *cos_vect_lookup(cos_vect_t *v, long id)
{
...
static inline int __cos_vect_expand(cos_vect_t *v, long id)
{
...
static inline int __cos_vect_set(cos_vect_t *v, long id, void *val)
{
	struct cos_vect_intern_struct *is = __cos_vect_lookup(v, id);
 ...
 */
static long cos_vect_add_id(cos_vect_t *v, void *val, long id)
{
	struct cos_vect_intern_struct *is;

...
stat.o,st.o,cm.o,sc.o,if.o,ip.o:\
\
...
stat.o-l.o;stat.o-print.o;stat.o-e.o;st.o-print.o;fprr.o-st.o;e.o-st.o;te.o-mm.o;\
http.o-cm.o;cm.o-print.o;cm.o-mm.o;sc.o-print.o;sc.o-mm.o;sc.o-te.o;cm.o-sc.o;\
cm.o-fprr.o;sc.o-e.o;sc.o-fprr.o;if.o-print.o;if.o-mm.o;if.o-l.o;net.o-ip.o;\
if.o-fprr.o;ip.o-if.o\
" ./gen_client_stub
